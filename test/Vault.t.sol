...
import {TwabEvent, TwabEventType, TwabLib} from "../src/libraries/TwabLib.sol";
...
contract VaultTest is Test {
    ...
    function testDeposit() public {
        ...
        console.log("Start time: ", myPool.getStartTime());
        console.log("End time: ", myPool.getEndTime());
        console.log("Created time: ", myPool.getCreatedTime());
        skip(50);
        console.log("Current time: ", block.timestamp);
        // TwabEvent[] memory events = vault.getEvents(myPoolAddress, myWallet);
